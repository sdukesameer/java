...
class Result {
    ...
    public static List<Integer> dynamicArray(int n, int q, List<List<Integer>> queries) {
...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        List<Integer> result = Result.dynamicArray(n, q, queries);
